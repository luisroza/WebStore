...
namespace WebStore.Core.Messages.CommonMessages.IntegrationEvents
{
    public class OrderStockConfirmedEvent : IntegrationEvent
    {
        ...
        public OrderStockConfirmedEvent(Guid customerId, Guid orderId, OrderItemList itemList, decimal total, string cardName, string cardNumber, string cardExpirationDate, string cardVerificationCode)
        {
            AggregateId = orderId;
